...
performSearch(searchTerm) {
  ...
  return (
   ...
   // <h1 className=" bg-light-pink">Movie App</h1>
   // <input  className='pa2 ba b--green bg-lightest' placeholder="type here" fontSize="24" display="block" width ="50%"/>
    //{this.state.rows}
    //</div>
     <div >
        ...
        <table className="titleBar">
          <tbody>
            <tr>
              ...
              <td>
                <img alt="app icon" width="50" src="https://cdn-icons-png.flaticon.com/128/8235/8235951.png"/>
              </td>
              <td width="8"/>
              <td>
